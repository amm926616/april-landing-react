    ...
    <section id={id} className={`py-16 ${className || ''}`}>
      <div className="max-w-4xl mx-auto px-4">
        ...
        <ul className="list-disc pl-5 mb-8 space-y-2">
          <li><strong className="font-semibold">Account Information:</strong> Email, username, and profile details</li>
          <li><strong className="font-semibold">Usage Data:</strong> Songs played, playlists created, and listening habits</li>
          <li><strong className="font-semibold">Device Information:</strong> Device type, operating system, and app performance data</li>
        </ul>
        ...
        <p className="mb-8">We implement industry-standard security measures to protect your data, but no system is 100% secure.</p>

        <h3 className="text-xl mt-8 mb-4">6. Changes to This Policy</h3>
        <p className="mb-8">We may update this policy periodically. We'll notify you of significant changes through the app or email.</p>

        <h3 className="text-xl mt-8 mb-4">7. Contact Us</h3>
        <p className="mb-4">For privacy questions, contact our Data Protection Officer at:</p>
